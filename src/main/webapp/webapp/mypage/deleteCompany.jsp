...
if( id == null ){
	 response.sendRedirect("CodeChatServlet?command=admin_login");
}
%> 
<fieldset>
	<legend>회원 탈퇴</legend>
	<form action="CodeChatServlet?command=deletecompany" method="post">
	<!-- input타입중 hidden은 화면에 있는 해당 input태그를 숨겨서 정보 전달   -->
		아이디 : <input type="text" name="id" value="<%=id %>" readonly><br>
		비밀번호 : <input type="password" name="password"><br>
		<input type="submit" class="btn" value="탈퇴하기">
		<input type="button" class="btn" value="뒤로가기" onclick="location.href='../index'">
	</form>
</fieldset>
</body>
</html>
